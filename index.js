...
function settime(){
    ...
    if(lunchtime == hours ) {
     ...
     if( naptime == hours ) {
        changeImage[0].style.backgroundImage='url("./Assets/goodnight_image.svg")';
...
function makeDiv(){
    ...
    document.getElementById("dynamic-block").innerHTML="Wakeup time: "+wakeupValue+"<br> Lunch time: "+lunchValue+ "<br> Nap time: "+napValue;
}
